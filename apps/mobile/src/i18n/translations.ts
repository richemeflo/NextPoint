...
export const dictionaries = {
  fr: {
    ...
    'notifications.courseSchedule': '{{date}} · {{start}}–{{end}}',
    ...
    'availability.filterLabel': 'Filtrer les plages',
    'availability.filter.all': 'Tout',
    'availability.filter.none': 'Ponctuel',
    'availability.filter.daily': 'Quotidien',
    'availability.filter.weekly': 'Hebdomadaire',
    ...
    'studentDetail.createTargetedRateAction': 'Créer un tarif ciblé',
    ...
    'booking.partnerSearchLabel': 'Rechercher un partenaire',
    'booking.partnerSearchPlaceholder': 'Nom ou prénom',
    'booking.partnerSearchHint':
      'Saisissez au moins deux lettres du nom ou du prénom.',
    'booking.partnerSearchLoading': 'Recherche...',
    'booking.partnerSearchEmpty': 'Aucun partenaire trouvé.',
    'booking.partnerSearchError':
    ...
    'booking.studentPageTitle': 'Mon agenda',
    ...
    'booking.nextLessonTitle': 'Prochain cours',
    'booking.nextLessonLoading': 'Chargement du prochain cours...',
    'booking.nextLessonEmpty': 'Aucun cours confirmé à venir.',
    'booking.nextLessonErrorTitle': 'Prochain cours indisponible',
    'booking.nextLessonErrorBody':
      'Impossible de charger votre prochain cours pour le moment.',
    'booking.nextLessonDate': 'Date',
    'booking.nextLessonTime': 'Heure',
    'booking.nextLessonLocation': 'Lieu',
    'booking.nextLessonType': 'Type de cours',
    'booking.nextLessonPartner': 'Partenaire',
    'booking.nextLessonPartners': 'Partenaires',
    'booking.nextLessonPartnerValue': 'Partenaire : {{names}}',
    'booking.nextLessonPartnersValue': 'Partenaires : {{names}}',
    'booking.nextLessonSummary': '{{date}} · {{time}}',
    'booking.nextLessonMeta': '{{location}} · {{lessonType}}',
    'booking.nextLessonViewInAgenda': "Voir dans l’agenda",
    'booking.addToGoogleCalendarCompact': 'Google Agenda',
    'booking.studentFilter.label': 'Filtrer par statut',
    'booking.studentFilter.all': 'Tous',
    'booking.studentFilter.emptyTitle': 'Aucun résultat',
    'booking.studentFilter.emptyBody':
      'Aucune demande ou aucun cours ne correspond à ce filtre.',
  ...
  en: {
    ...
    'availability.filterLabel': 'Filter saved ranges',
    'availability.filter.all': 'All',
    'availability.filter.none': 'One-off',
    'availability.filter.daily': 'Daily',
    'availability.filter.weekly': 'Weekly',
    ...
    'studentDetail.createTargetedRateAction': 'Create targeted rate',
    'studentDetail.incompleteProfileBody':
    ...
    'booking.participantsLabel': 'Participants',
    'booking.partnerSearchLabel': 'Search for a partner',
    'booking.partnerSearchPlaceholder': 'First or last name',
    'booking.partnerSearchHint':
      'Enter at least two letters from the first or last name.',
    'booking.partnerSearchLoading': 'Searching...',
    'booking.partnerSearchEmpty': 'No partner found.',
    'booking.partnerSearchError':
      'Search is unavailable. Please try again shortly.',
    'booking.duoParticipantRequired':
    ...
    'booking.studentPageTitle': 'My calendar',
    'booking.studentPageBody':
    ...
    'booking.nextLessonTitle': 'Next lesson',
    'booking.nextLessonLoading': 'Loading your next lesson...',
    'booking.nextLessonEmpty': 'No upcoming confirmed lesson.',
    'booking.nextLessonErrorTitle': 'Next lesson unavailable',
    'booking.nextLessonErrorBody':
      'Your next lesson cannot be loaded right now.',
    'booking.nextLessonDate': 'Date',
    'booking.nextLessonTime': 'Time',
    'booking.nextLessonLocation': 'Location',
    'booking.nextLessonType': 'Lesson type',
    'booking.nextLessonPartner': 'Partner',
    'booking.nextLessonPartners': 'Partners',
    'booking.nextLessonPartnerValue': 'Partner: {{names}}',
    'booking.nextLessonPartnersValue': 'Partners: {{names}}',
    'booking.nextLessonSummary': '{{date}} · {{time}}',
    'booking.nextLessonMeta': '{{location}} · {{lessonType}}',
    'booking.nextLessonViewInAgenda': 'View in calendar',
    'booking.addToGoogleCalendarCompact': 'Google Calendar',
    'booking.studentFilter.label': 'Filter by status',
    'booking.studentFilter.all': 'All',
    'booking.studentFilter.emptyTitle': 'No results',
    'booking.studentFilter.emptyBody':
      'No request or lesson matches this filter.',
  ...
  es: {
    ...
    'availability.filterLabel': 'Filtrar franjas guardadas',
    'availability.filter.all': 'Todo',
    'availability.filter.none': 'Puntual',
    'availability.filter.daily': 'Diario',
    'availability.filter.weekly': 'Semanal',
    ...
    'studentDetail.createTargetedRateAction': 'Crear tarifa específica',
    'studentDetail.incompleteProfileBody':
    ...
    'booking.partnerSearchLabel': 'Buscar una pareja',
    'booking.partnerSearchPlaceholder': 'Nombre o apellido',
    'booking.partnerSearchHint':
      'Introduce al menos dos letras del nombre o apellido.',
    'booking.partnerSearchLoading': 'Buscando...',
    'booking.partnerSearchEmpty': 'No se encontró ninguna pareja.',
    'booking.partnerSearchError':
      'La búsqueda no está disponible. Inténtalo de nuevo en breve.',
    'booking.duoParticipantRequired':
    ...
    'booking.studentPageTitle': 'Mi agenda',
    'booking.studentPageBody':
    ...
    'booking.nextLessonTitle': 'Próxima clase',
    'booking.nextLessonLoading': 'Cargando tu próxima clase...',
    'booking.nextLessonEmpty': 'No hay ninguna clase confirmada próxima.',
    'booking.nextLessonErrorTitle': 'Próxima clase no disponible',
    'booking.nextLessonErrorBody':
      'No se puede cargar tu próxima clase en este momento.',
    'booking.nextLessonDate': 'Fecha',
    'booking.nextLessonTime': 'Hora',
    'booking.nextLessonLocation': 'Lugar',
    'booking.nextLessonType': 'Tipo de clase',
    'booking.nextLessonPartner': 'Pareja',
    'booking.nextLessonPartners': 'Participantes',
    'booking.nextLessonPartnerValue': 'Pareja: {{names}}',
    'booking.nextLessonPartnersValue': 'Participantes: {{names}}',
    'booking.nextLessonSummary': '{{date}} · {{time}}',
    'booking.nextLessonMeta': '{{location}} · {{lessonType}}',
    'booking.nextLessonViewInAgenda': 'Ver en la agenda',
    'booking.addToGoogleCalendarCompact': 'Google Calendar',
    'booking.studentFilter.label': 'Filtrar por estado',
    'booking.studentFilter.all': 'Todos',
    'booking.studentFilter.emptyTitle': 'Sin resultados',
    'booking.studentFilter.emptyBody':
      'Ninguna solicitud o clase coincide con este filtro.',
